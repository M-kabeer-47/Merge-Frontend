      ...
      {viewMode === "list" ? (
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-[40px_1fr_40px] sm:grid-cols-[50px_1fr_180px_200px_50px] gap-2 sm:gap-4 px-3 py-2">
            ...
            <div className="hidden sm:block h-4 w-20 bg-secondary/10 rounded" />
            <div className="hidden sm:block h-4 w-24 bg-secondary/10 rounded" />
            <div className="w-4" />
          </div>
          ...
          {Array.from({ length: itemCount }).map((_, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="h-8 w-8 sm:h-10 sm:w-10 bg-secondary/10 rounded-lg flex-shrink-0" />
                <div className="flex-1 min-w-0">
                  <div className="h-4 w-24 sm:w-32 bg-secondary/10 rounded mb-1" />
                  <div className="h-3 w-16 sm:w-20 bg-secondary/10 rounded sm:hidden" />
                </div>
              </div>
              ...
              {/* Menu */}
              <div className="flex items-center justify-center">
                <div className="h-5 w-5 bg-secondary/10 rounded" />
              </div>
            </motion.div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
          {Array.from({ length: itemCount }).map((_, i) => (
            ...
            >
              <div className="h-20 sm:h-24 w-full bg-secondary/10 rounded-lg mb-2 sm:mb-3" />
              <div className="h-4 w-3/4 bg-secondary/10 rounded mb-2" />
