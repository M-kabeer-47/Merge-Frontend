        ...
        <div className="flex items-center justify-between animate-pulse">
          <div className="flex items-center gap-4 min-w-0">
            <div className="min-w-0 flex-1">
              {/* Title skeleton */}
              <div className="h-6 md:h-7 lg:h-8 bg-gray-200 rounded w-48 md:w-64 mb-1" />
      ...
      <div className="bg-background">
        <div className="relative z-10 bg-main-background px-2 py-2">
          <nav className="relative overflow-x-auto">
            <div className="flex items-center relative min-w-max sm:min-w-0 justify-start gap-2 sm:gap-1 animate-pulse">
              {[...Array(7)].map((_, i) => (
                <div
                  key={i}
                  className="flex items-center gap-1 sm:gap-1 px-3 sm:px-4 py-3 min-w-[120px] h-[70px]"
                >
                  <div className="w-4 h-4 bg-gray-200 rounded w-full" />
                  <div className="h-4 w-16 bg-gray-200 rounded hidden xs:block w-full" />
                </div>
              ))}
            </div>
          </nav>
      ...
      <main className="flex-1 min-h-0 overflow-hidden">
        <div className="h-full bg-background p-6">
          <div className="space-y-4 animate-pulse">
            ...
            <div className="h-[calc(100vh-200px)] bg-gray-200 rounded-lg" />
          </div>
        </div>
      </main>
    </div>
